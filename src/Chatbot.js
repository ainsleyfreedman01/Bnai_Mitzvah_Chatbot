...
function Chatbot() {
    ...
    const getThoughts = (userMessage, prayer) => {
        ...
        } else if (prayer === "bar'chu" && (userMessage.toLowerCase().includes("beginning") || userMessage.toLowerCase().includes("start"))) {
        ...
        } else if (prayer === "bar'chu" && userMessage.toLowerCase().includes("bless")) {
        ...
        } else if (prayer === "sh'ma" && userMessage.toLowerCase().includes("listen")) {
        ...
        } else if (prayer === "sh'ma" && userMessage.toLowerCase().includes("important")) {
        ...
        } else if (prayer === "v'ahavta" && userMessage.toLowerCase().includes("commandments")) {
        ...
        } else if (prayer === "v'ahavta" && userMessage.toLowerCase().includes("love")) {
        ...
        } else if (prayer === "adonai s'fatai" && userMessage.toLowerCase().includes("open")) {
        ...
        } else if (prayer === "adonai s'fatai" && userMessage.toLowerCase().includes("praise")) {
        ...
        } else if ((prayer === "avot v'imahot" || prayer === "avot") && userMessage.toLowerCase().includes("ancestors")) {
        ...
        } else if (prayer === "g'vurot" && (userMessage.toLowerCase().includes("power") || userMessage.toLowerCase().includes("strength"))) {
        ...
        } else if (prayer === "mourner's kaddish" && userMessage.toLowerCase().includes("peace")) {
        ...
        } else if (prayer === "mourner's kaddish" && userMessage.toLowerCase().includes("mourning")) {
        ...
        } else if (prayer === "k'dushah" && (userMessage.toLowerCase().includes("holy") || userMessage.toLowerCase().includes("holiness")) && selectedCategory === "morning") {
        ...
        } else if (prayer === "k'dushah" && (userMessage.toLowerCase().includes("holy") || userMessage.toLowerCase().includes("holiness")) && selectedCategory === "evening") {
        ...
        } else if (prayer === "l'cha dodi" && (userMessage.toLowerCase().includes("shabbat") || userMessage.toLowerCase().includes("sabbath") || userMessage.toLowerCase().includes("welcome"))) {
